...
public class TestBookingMultipleTimes extends TestCase implements TicketServiceConstants
{
	...
	TicketServiceMaintenance ticketServiceMaintenance=null;
     ...
     public void testBookingMultipleTimes(){
      ...
      reservationCode=ticketService.reserveSeats((int)(seatHold.getSeatHoldId()), "ticketService@test.com");
