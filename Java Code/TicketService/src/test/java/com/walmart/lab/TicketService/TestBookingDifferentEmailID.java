...
public class TestBookingDifferentEmailID extends TestCase implements TicketServiceConstants
{
	...
	TicketServiceMaintenance ticketServiceMaintenance=null;
     ...
     public void testBookingDifferentEmailID(){
      ...
      String reservationCode=ticketService.reserveSeats((int)(seatHold.getSeatHoldId()), "ticketServiceDifferent@test.com");
