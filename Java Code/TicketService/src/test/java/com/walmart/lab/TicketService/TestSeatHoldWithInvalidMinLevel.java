...
public class TestSeatHoldWithInvalidMinLevel extends TestCase implements TicketServiceConstants
{
	...
	TicketServiceMaintenance ticketServiceMaintenance=null;
     ...
     public void testSeatHoldWithInvalidMinLevel(){
      ...
      //Try to Hold some of the seats with invalid min level
      SeatHold seatHold=ticketService.findAndHoldSeats(seatCount>10?5:seatCount, Optional.ofNullable(1), Optional.ofNullable(8), "ticketService@test.com");
