...
public class TestSeatHoldWithInvalidSeatCount extends TestCase implements TicketServiceConstants
{
	...
	TicketServiceMaintenance ticketServiceMaintenance=null;
     ...
     public void testSeatHoldWithInvalidSeatCount(){
      ...
      //Try to Hold some of the seats with invald seat count
      SeatHold seatHold=ticketService.findAndHoldSeats(-1, Optional.ofNullable(0), Optional.ofNullable(4), "ticketService@test.com");
