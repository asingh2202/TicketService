...
public class TestSeatHoldMoreThanAvailabilty extends TestCase implements TicketServiceConstants
{
	...
	TicketServiceMaintenance ticketServiceMaintenance=null;
     ...
     public void testSeatHoldMoreThanAvailabilty(){
      ...
      //try to Hold the seats more than available
